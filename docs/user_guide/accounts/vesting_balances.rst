...
In AFRICUNIA 2.0, some balances are vesting over time. This feature has been introduced initially in AFRICUNIA 1 when merging several blockchain businesses into one blockchain.
...
For instance, a worker can define for how long he would like his pay to vest to encourage AFCASH Holders to vote for him due to no imminent additional sell pressure from the worker.
...
-----------------------------
 ...
 You can claim vesting balances by using AFRICUNIA User interface. (You might need to wait certain days to claim.)
