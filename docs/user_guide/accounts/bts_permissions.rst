...
In AFRICUNIA, each account is separated into the permission types below;
...
- **Authorities** :In AFRICUNIA an authority consists of one or many entities that authorize an action, such as transfers or trades. 
...
Read more about :ref:`AFCASH-multi-sign` 
